...
function SC(id){
	$.getJSON("<?php echo U('houtianyouhuiquan/delete');?>",{id:id}, function(result){
		$("#TS").empty();
		if (result.ts == 'OK'){
			$("#TS").append('删除成功！');
		}else{
...
function CJ(cate,cate1){
	$.getJSON("<?php echo U('houtianyouhuiquan/add');?>",{cate:cate,cate1:cate1}, function(result){
		$("#TS").empty();
		if (result.ts == 'OK'){
			$("#TS").append('添加成功！');
		}else{
