...
</script><div class="app"><div class="search_warp1"><span id="classify" class="classify"><a href="javascript:;" class="btn btn-left btn-type"></a></span><div class="search" style="float: none;"><form name="search" action="<?php echo C('search/index');?>" method="get" id="search"><input type="hidden" name="m" value="search"><input type="hidden" name="a" value="index"><div class="seek_main"><input type="text" name="k" onclick="if(this.value=='请输入内容'){this.value='';this.className='seek_input seek_input_h'}" onblur="if(this.value==''){this.value='请输入内容';this.className='seek_input seek_input_f'}" class="seek_input seek_input_f" value="请输入内容"><button type="submit" id="k" onclick="document.getElementById('k').value=encodeURI(document.getElementById('k').value);getId('search').submit()" class="seek_btn" value="搜本站"><img src="__STATIC__/jwap/images/search.png"></button></div></form></div></div><header id="head" class="head"></header><?php echo R('advert/index', array(12), 'Widget');?><div class="index_w"><ul class="category"><?php $tag_nav_class = new navTag;$data = $tag_nav_class->lists(array('type'=>'lists','style'=>'other','cache'=>'0','return'=>'data',)); if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="houtian_1" data-url="<?php echo ($val["link"]); ?>"><span><img src="<?php echo attach($val['icon'],'m');?>" alt="<?php echo ($val["name"]); ?>"></span><strong><?php echo ($val["name"]); ?></strong></li><?php endforeach; endif; else: echo "" ;endif; ?></ul><div class="h_navv"><ul><li><a href="<?php echo U('jiu/index');?>" target="_self" ><img src="__STATIC__/jwap/images/img15.png" /></a></li><li><a href="<?php echo U('shijiu/index');?>" target="_self"><img src="__STATIC__/jwap/images/img16.png" /></a></li></ul></div><div class="hot_recommend"><dl class="today houtian_1" data-url="<?php echo U('quan/index');?>"><dt class="tt1">优惠券</dt><dd class="txt">每日10:00更新</dd><dd class="img"><img src="\static\jwap\images\waptubiao\todynew.png" width="108" alt=""><span></span></dd><!-- dl--></dl><dl class="rec_item houtian_1" data-url="<?php echo U('quan/index?cid=36');?>" _hover-ignore="1"><dt class="tt2">母婴生活</dt><dd class="txt">我是爱省钱的妈妈</dd><dd class="img"><img src="\static\jwap\images\waptubiao\55ee25e227b08.png" width="45" alt="我是爱省钱的妈妈"></dd><!-- dl--></dl><dl class="rec_item houtian_1" data-url="<?php echo U('quan/index?cid=37');?>"><dt class="tt3">美妆</dt><dd class="txt">就是要你好看</dd><dd class="img"><img src="\static\jwap\images\waptubiao\55ee25ad427f5.png" width="45" alt="就是要你好看"></dd><!-- dl--></dl><dl class="rec_item houtian_1" data-url="<?php echo U('quan/index?cid=38');?>"><dt class="tt2">居家</dt><dd class="txt">享受品质生活</dd><dd class="img"><img src="\static\jwap\images\waptubiao\55ee26066f7d4.png" width="45" alt="享受品质生活"></dd><!-- dl--></dl><dl class="rec_item houtian_1" data-url="<?php echo U('article/index');?>"><dt class="tt3">时尚美文</dt><dd class="txt">购物搭配新技能get</dd><dd class="img"><img src="\static\jwap\images\waptubiao\55ee257497dd5.png" width="45" alt="购物搭配新技能get"></dd><!-- dl--></dl></div></div><div class="h_bmbk"><?php if(C('ht_wap_template') == '1'): ?><div class="goods_list" id="box_list"><ul id="goods_box"></ul><div class="more" id='mores'><a href="javascript:void(0);" onclick="get_list(0)">加载中..</a></div></div><?php endif; if(C('ht_wap_template') == '2'): ?><div class="goods_list" id="box_list"><ul id="goods_box"></ul><div class="more" id='mores'><a href="javascript:void(0);" onclick="get_list(0)">加载中..</a></div></div><?php endif; ?></div><?php if(C('ht_wap_template') == '3'): ?><div id="goods"><section class="goods" id="goods"><ul class="goods-list clear"><script>$(function (){
...
/*foot end*/
	...
	//		alert(limit);
			...
			$.ajax({
        type:"get",
        url:"<?php echo C('ht_header_html');?>?m=index&a=getlist",
        data:{"p":limit},
        dataType:"json",	
...
//			    	alert(data.status);
	...
	</script><script type="text/javascript">    $(".houtian_1").off("click").on("click",function(){
       window.location.href = $(this).attr("data-url");
    });
</script><script type="text/javascript" src="__STATIC__/jwap/js/mjp.min.js"></script><script src="__STATIC__/newpi/js/lightbox.js" type="text/javascript"></script><script type="text/javascript">	$("img.lazy").lazyload({threshold:200,failure_limit:30});	
