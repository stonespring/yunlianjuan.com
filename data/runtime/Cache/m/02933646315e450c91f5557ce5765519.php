...
/*foot end*/
		...
		//alert(sort);
			$.ajax({
        type:"get",
        url:"<?php echo C('ht_header_html');?>?m=jiu&a=getitemlist",
        data:{"tag":jiutag,"p":jiulimit},
        dataType:"json",	
	...
	//	content +='<span class="fan">0.5</span>';
		...
		content +='</li>';
                ...
                jiulimit++;
				window.sessionStorage.setItem("jiulimit", jiulimit);
				window.sessionStorage.setItem("jiutag", jiutag);
		//lazy_img();
