<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0"><meta name="viewport" content="initial-scale=1, width=device-width, maximum-scale=1, user-scalable=no"><meta name="viewport" content="initial-scale=1.0,user-scalable=no,maximum-scale=1" media="(device-height: 568px)"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-touch-fullscreen" content="yes"><meta name="full-screen" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black"><meta name="format-detection" content="telephone=no"><meta name="format-detection" content="address=no"><link href="__STATIC__/jwap/css/style_v3.css" rel="stylesheet" type="text/css" /><link href="__STATIC__/jwap/css/jp.bag.css" rel="stylesheet" type="text/css" /><link href="__STATIC__/wap/css/swiper.min.css" rel="stylesheet"><link rel="stylesheet" type="text/css" href="__STATIC__/wap/css/wapshow.css" /><link rel="stylesheet" type="text/css" href="__STATIC__/wap/css/wap.css" /><link type="text/css" rel="stylesheet" href="__STATIC__/jwap/css/iconfont.css" /><link type="text/css" rel="stylesheet" href="__STATIC__/jwap/css/iconfont3.css" /><script type="text/javascript" src="__STATIC__/jwap/js/jquery-1.7.2.min.js"></script><script src="https://cdn.jsdelivr.net/clipboard.js/1.5.12/clipboard.min.js"></script><title><?php echo ($page_seo["title"]); ?></title><meta name="keywords" content="<?php echo ($page_seo["keywords"]); ?>"><meta name="description" content="<?php echo ($page_seo["description"]); ?>"><script src="__STATIC__/jwap/js/jquery-1.8.0.js"></script><script src="__STATIC__/jwap/js/underscore.js"></script><script src="__STATIC__/jwap/js/layer.js"></script><script type="text/javascript">	SITEURL="<?php echo C('ht_header_html');?>";
	...
	URL_COOKIE=0;
</script><link type="text/css" rel="stylesheet" href="__STATIC__/jwap/css/alert.css" /><link type="text/css" rel="stylesheet" href="__STATIC__/jwap/css/global.css" /><link type="text/css" rel="stylesheet" href="__STATIC__/jwap/css/iconfont2.css" /><link type="text/css" rel="stylesheet" href="__STATIC__/jwap/css/iconfont4.css" /></head><body><div class="main"><div class="app"><header id="head" class="head"><div class="fixtop"><span id="t-find"><a class="btn btn-left btn-back" href="<?php echo U('index/index');?>" title="返回网站首页"></a></span><span id="t-index">个人中心</span><span id="user"><a href="javascript:;" class="sign_btn btn btn-right btn-sign"></a></span></div></header><div class="user-box"><ul class="action-list1 user-show1"><li><img src="<?php echo avatar($info['id'], 100);?>" class="profile1" style="width:60px;height:60px;"></li><li><span><?php echo ($info["username"]); ?></span></li></ul><table width="100%" border="0" cellpadding="0" cellspacing="0"><tbody><tr style="height:30px;line-height:20px;" class="info-agul"><td align="center" valign="bottom" style="font-size:1.4rem;"><font color="#2ec300"><?php echo ($info["available_money"]); ?></font></td><td align="center" valign="bottom" style="font-size:2rem;"><a href="<?php echo U('user/cash');?>"><font color="#2ec300"><?php echo ($info["money"]); ?></font></a></td><td align="center" valign="bottom" style="font-size:1.4rem;"><font color="#2ec300"><?php echo ($info["score"]); ?></font></td></tr><tr style="height:30px;line-height:20px;"><td align="center"valign="top" style="font-size:1.4rem;">账户余额</td><td align="center"valign="top" style="font-size:1.4rem;">可用余额</td><td align="center"valign="top" style="font-size:1.4rem;">账户积分</td></tr></tbody></table><ul class="action-list"><?php if($rebate_open['data'] == 1): ?><li><a href="javascript:;"><span>我的订单</span><em class="cur"></em></a></li><table width="100%" border="0" cellpadding="0" cellspacing="0"><tbody><tr style="height:35px;line-height:20px;"><td align="center"valign="bottom" ><a href="<?php echo U('user/rebate');?>" class="icon iconfont icon-dingdan" ></a></td><td align="center"valign="bottom" ><a href="<?php echo U('user/subrebate');?>" class="icon iconfont icon-tijiaodingdan" ></a></td><td align="center"valign="bottom" ><a href="<?php echo U('user/rebacomplain');?>" class="icon iconfont icon-dingdanshensu" ></a></td></tr><tr style="height:30px;line-height:20px;"><td align="center" style="font-size:1rem;">全部订单</td><td align="center" style="font-size:1rem;">提交订单</td><td align="center" style="font-size:1rem;">订单申诉</td></tr></tbody></table><?php endif; if($info["parent_uid"] == 0): ?><li><a href="javascript:;"><span>我的代理</span><em class="cur"></em></a></li><table width="100%" border="0" cellpadding="0" cellspacing="0"><tbody><tr style="height:35px;line-height:20px;"><?php if(($info["agent_id"]) == "0"): ?><td align="center"valign="bottom" ><a href="<?php echo U('user/agentapply');?>" class="icon iconfont4 icon-shenqingfenxiao"  target="_blank"></a></td><?php endif; ?><td align="center"valign="bottom" ><a href="<?php echo U('user/agent');?>" class="icon iconfont icon-shouye" ></a></td><td align="center"valign="bottom" ><a href="<?php echo U('user/getIvtFriends');?>" class="icon iconfont icon-duiwu" ></a></td></tr><tr style="height:30px;line-height:20px;"><?php if(($info["agent_id"]) == "0"): ?><td align="center" style="font-size:1rem;">申请代理</td><?php endif; ?><td align="center" style="font-size:1rem;">代理订单</td><td align="center" style="font-size:1rem;">我的队伍</td></tr></tbody></table><?php endif; ?><li><a href="javascript:;"><span>我的积分</span><em class="cur"></em></a></li><table width="100%" border="0" cellpadding="0" cellspacing="0"><tbody><tr style="height:35px;line-height:20px;"><td align="center"valign="bottom" ><a href="<?php echo U('user/mingxi');?>" class="icon iconfont icon-jifenmingxi" ></a></td><td align="center"valign="bottom" ><a href="<?php echo U('user/gift');?>" class="icon iconfont icon-quanduihuanmingxi" ></a></td><td align="center"valign="bottom" ><a href="<?php echo U('gift/index');?>" class="icon iconfont icon-jifenshangcheng" ></a></td></tr><tr style="height:30px;line-height:20px;"><td align="center" style="font-size:1rem;">积分明细</td><td align="center" style="font-size:1rem;">兑换明细</td><td align="center" style="font-size:1rem;">积分商城</td></tr></tbody></table><li><a href="javascript:;"><span>更多</span><em class="cur"></em><span class="rest"></span></a></li><table width="100%" border="0" cellpadding="0" cellspacing="0"><tbody><tr style="height:35px;line-height:20px;"><td align="center"valign="bottom" ><a href="<?php echo U('user/union');?>" class="icon iconfont icon-yaoqing" ></a></td><td align="center"valign="bottom" ><a href="<?php echo U('user/like');?>" class="icon iconfont icon-shoucangjia" ></a></td></tr><tr style="height:30px;line-height:20px;"><td align="center" style="font-size:1rem;">邀请赚积分</td><td align="center" style="font-size:1rem;">我的收藏</td></tr></tbody></table></ul><ul class="action-list"><li><a href="<?php echo U('user/logout');?>"><em class="icon icon-help"></em><span>退出登录</span><em class="cur"></em></a></li></ul></div><div class="nav_box"><nav class="nav" id="nav"><ul class="" id="bot-nav"><?php $tag_nav_class = new navTag;$data = $tag_nav_class->lists(array('type'=>'lists','style'=>'botmenu','cache'=>'0','return'=>'data',)); if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a class="active" href="<?php echo ($val["link"]); ?>" target="_self"><img src="<?php echo attach($val['icon'],'m');?>" alt="<?php echo ($val["name"]); ?>" class="icon icon-bm"><span style="color:#ff7200;"><?php echo ($val["name"]); ?></span><em class="line"></em></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></nav></div><div  id="back_top"  class="slide-box" style="display:none"><a href="<?php echo U('user/like');?>" class="bag-enter" title="我的收藏"><img src="/static/jwap/images/bag-icon.png" alt="我的收藏"></a><a href="#" class="back-top" title="返回顶部"><img src="/static/jwap/images/back-top.png" alt="返回顶部"></a></div><div id="foot"><div class="foot-nav"></div></div><script type="text/javascript">var HTIANER = {
    root: "__ROOT__",
