$(function(){
    ...
    var contentJp = '<div class="mobile_select jp_select clear">'
        ...
        +'<li><div class="n-wechat fl"><img src="http://www.houtianbest.cn/pic/1490543394130.png"><br>手机扫描二维码下载</div><div class="n-download fr"><a href="http://show.houtianbest.cn/15365/APPdownload/houtianbest.apk" class="jp_download"></a>直接下载到电脑</div></li>'
        +'<li><div class="n-wechat fl"><img src="http://www.houtianbest.cn/pic/1490543394130.png"><br>手机扫描二维码下载</div><div class="n-download fr"><a href="http://show.houtianbest.cn/15365/APPdownload/houtianbest.ipa" class="jp_download"></a>前往appstore下载</div></li>'
        +'<li><div class="n-wechat fl"><img src="http://www.houtianbest.cn/pic/1490543394130.png"><br>手机扫描二维码下载</div><div class="n-download fr"><a href="http://show.houtianbest.cn/15365/APPdownload/houtianbest.ipa"></a>前往appstore下载</div></li>'
        +'</ul></div>';
    var contentJky = '<div class="mobile_select clear">' +
        ...
        '</div>' +
        '<div class="mobile_con clear"><ul class="fix_box" >' +
        '<li><div class="n-wechat fl"><img src="http://www.houtianbest.cn/pic/1490543394130.png"><br>手机扫描二维码下载</div><div class="n-download fr"><a class="jky_download" href="http://show.houtianbest.cn/15365/APPdownload/houtianbest.apk" ></a>直接下载到电脑</div></li>' +
        '<li><div class="n-wechat fl"><img src="http://www.houtianbest.cn/pic/1490543394130.png"><br>手机扫描二维码下载</div><div class="n-download fr"><a class="jky_download" href="http://show.houtianbest.cn/15365/APPdownload/houtianbest.ipa" ></a>前往appstore下载</div></li>' +
        '<li><div class="n-wechat fl"><img src="http://www.houtianbest.cn/pic/1490543394130.png"><br>手机扫描二维码下载</div><div class="n-download fr"><a class="jky_download" href="http://show.houtianbest.cn/15365/APPdownload/houtianbest.ipa" ></a>前往appstore下载</div></li>' +
        '</ul></div>';
