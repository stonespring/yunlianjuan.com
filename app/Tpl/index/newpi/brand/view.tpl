           ...
           <li class="<eq name='mod' value='3'> last</eq>" gtype="1" id="{$item.id}">
                <div class="list-good buy">
                    <div class="good-pic">
                        ...
                        <img alt="{$item.title}" src="{:C('ht_site_flogo')}" class="lazy good-pic" d-src="{:attach(get_thumb($item['pic_url'], '_b'),'item')}" data-bimg="{$item['pic_url']}"/><span class="brand-icon"></span></a>
                     </div>
                    <h3 class="good-title">
