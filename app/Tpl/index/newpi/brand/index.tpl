...
<div class="bd">
<ul class="goods-list">
<ht:item type="brand" cid="$val['activityId']" num="8">
...
<li class="<eq name='mod' value='3'> last</eq><eq name='mod' value='7'> last</eq>" gtype="1" id="{$item.id}">
    <div class="list-good buy">
        <div class="good-pic">
		<a href="{:U('brand/item',array('id'=>$item['id']))}"  target="_blank" class="pic-img"><img src="{:C('ht_site_flogo')}" class="lazy good-pic" d-src="{:attach(get_thumb($item['pic_url'], '_b'),'item')}" alt="{$item.title}"><span class="brand-icon"></span></a>
		</div>
        <h3 class="good-title">		
