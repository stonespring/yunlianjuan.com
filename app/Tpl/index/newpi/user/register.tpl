...
<html>
    <head>
        <title>{$page_seo.title}  {:C('ht_site_name')}</title>
    ...
    <body>
        ...
        <div class="area">
                            <div class="logo">
                    <div class="fl">
                        <a href="{:C('ht_site_url')}" title="{:C('ht_site_name')}" class="juan-logo fl"><img src="{:C('ht_site_logo')}"></a></div>
                </div>
                <div class="protection" style="background: url({:C('ht_site_navlogo')}) no-repeat;">
    ...
    <div class="login-content">
        <div class="title"><span class="hd">新用户注册</span><span class="tips">注册{:C('ht_site_name')}，得积分换好礼！</span><p class="other">已有账号，<a href="{:U('user/login')}">立即登录</a></p></div>
            ...
            <div class="content-landing fl">
                <form action="{:U('user/register')}" name="register_form" method="post" id="register_form">
                  ...
                  <label>
                     ...
                     {:L('i_agree')}《<a href="javascript:;" id="J_protocol_btn">{:C('ht_site_name')}{:L('user_protocol')}</a>》</label>
                  </span></div>                            
                        </li>
                        <li>
                            <label class="normal"></label>
    ...
    </div><p class="foot-tips">{:C('ht_site_name')} <a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">{:C('ht_site_icp')}</a>   Copyright © 2010 - 2014 {:C('ht_site_url')} All Rights Reserved</p>
        </div>
    </div>
...
<ht:load type="js" href="__STATIC__/js/htian.js" />
<div id="J_protocol" class="hide"><pre class="dialog_protocol clr6">{:C('ht_reg_protocol')}</pre></div>
</body>
</html>