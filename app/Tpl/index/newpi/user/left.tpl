<div class="left">
			<div class="user">
				...
				<div class="user-info">
					...
					<div><eq name="info.login_type" value="2">商家用户<else/><volist name="agent_li" id="agent_info"><if condition="$info['agent_id'] eq $agent_info['id']">{$agent_info.name}</if></volist></eq></div>
			...
			<div class="user-bind">
				...
				<a href="{:U('user/bind')}">
					<volist name="oauth_list" id="val">
						...
						<div title="绑定后可用{$val.name}{:C('ht_site_name')}" class="ico {$val.code}_sync"></div>
						<else/>
						<div title="绑定后可用{$val.name}{:C('ht_site_name')}" class="ico {$val.code}_sync_no"></div>
						</if>
					</volist>
                		</a>
			</div>
				...
				<if condition="$info.parent_uid eq 0">	
						...
						<div class="nav-title">
							<div class="nav-mouse">
								...
								<a href="{:U('user/agent')}"><div class="nav-name">代理</div></a>
							</div>
							<div class="nva-la"></div>
						</div>
						<div class="nav-sub">
							...
							<div class="nav-body">	  
								<div class="nav-center">	 
									...
									<eq name ="info.agent_id" value="0">
										<li><a href="{:U('user/agentapply')}">申请代理</a></li>
									</eq>	
										<li><a href="{:U('user/agent')}">代理订单</a></li>
										<li><a href="{:U('user/getIvtFriends')}">我的队伍</a></li>
									</ul>
								</div>
							</div>
							<div class="nav-foot-bg"></div>
					...
					<if condition="$rebate_open['data'] eq 1">	
						...
						<div class="nav-title">
							<div class="nav-mouse">
								...
								<a href="{:U('user/rebate')}"><div class="nav-name">返利订单</div></a>
							</div>
							<div class="nva-la"></div>
						</div>
						<div class="nav-sub">
							...
							<div class="nav-body">	  
								<div class="nav-center">	 
									<ul>
										<li><a href="{:U('user/rebate')}">我的订单</a></li>
										<li><a href="{:U('user/subrebate')}">提交订单</a></li>
										<li><a href="{:U('user/rebacomplain')}">订单申诉</a></li>
									</ul>
								</div>
							</div>
							<div class="nav-foot-bg"></div>
