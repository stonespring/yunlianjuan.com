    ...
    <div class="login-content">
        ...
        <div class="login-center">
                    ...
                    <ul>
                        ...
                        <li class="third-login">
                            ...
                            <div class="union-login">
                                <p class="union-title"><span>合作网站账号登录</span><em class="line"></em></p>
                                <div class="third-box">
           ...
           {:R('advert/index', array(4), 'Widget')}
            ...
            <p class="foot-tips">{:C('ht_site_name')} <a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">{:C('ht_site_icp')}</a>   Copyright © 2010 - 2014 {:C('ht_site_url')} All Rights Reserved</p>
        </div>
    </div>
