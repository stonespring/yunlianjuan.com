...
.fanli-price { width:300px; height:40px;line-height:30px; position: relative;padding:0 10px 0px 5px; z-index:10;}
.fanli-price .fanli-current {border-radius:10px 0 0 10px; background-color:#3f9d00;width:130px; height:35px;display:block;float:left;}
.fanli-price .fanli-current .ft {font-size: 14px; font-family:"微软雅黑","verdana"; vertical-align:1px;text-align:center;color:#ffffff;}
.fanli-price .fanli-current1 {border-radius:0 10px 10px 0;width:130px; height:35px;border:1px dashed #3f9d00;display:block;float:left;}
...
<div class="nav-wrap">
<div class="text">当前位置：<a href="{:C('ht_site_url')}">首页</a>&gt;<a href="{:U('quan/index')}">领券直播</a>&gt;&nbsp;优惠详情
</div>
</div>
<div class="detail-row clearfix">
<a rel="nofollow" href="{:U('jump/index',array('id'=>$item['id']))}" target="_blank" class="img cnzzCounter" data-cnzz-type="1" data-cnzz="31142"><img src="{$item.pic_url}_400x400.jpg" alt="{$item.title}">
...
<a class="more-btn" href="{:C('ht_site_url')}"">查看更多</a>
<script>
(function(){
    // 领券箭头移动
    var direction='right';
...
<div class="text" style="color: #a2a2a2;
    font-size: 16px;
    margin-top: 33px;">© CopyRight&nbsp;2016 &nbsp;<a href="{:C('ht_site_url')}" target="_blank" rel="nofollow" style="color:#a2a2a2;">{:C('ht_site_name')}</a>
&nbsp;{:C('ht_site_url')}&nbsp;&nbsp;<a href="http://www.miitbeian.gov.cn/" target="_blank" rel="nofollow" style="color:#a2a2a2;">{:C('ht_site_icp')}</a>
&nbsp;&nbsp; <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin={:C('ht_qq')}&amp;site=qq&amp;menu=yes" style="color: #8da7cb" title="联系我帮你解答">^_^亲遇到问题，联系我帮你处理哈</a>
</div>
</div>
</div>
