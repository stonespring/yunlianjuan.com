		...
		<div class="bady-part clear">
			...
			<div class="information" style="display:block">
				<div class="rule-explain mb20">
					<dl>
						<dt>兑换说明</dt>
						<dd>1、兑换开始后，所有{:C('ht_site_name')}会员均可点击“我要兑换”按钮进行兑换。</dd>
						<dd>2、为了更好的回馈会员，所有的礼品兑换不收取任何费用（实物礼品我们包邮为您送到家）。</dd>
						<dd>3、只能使用在{:C('ht_site_name')}获得的积分兑换，积分余额不足则不能兑换。</dd>
				...
				<div class="rule-explain mb20">
					<dl>
						...
						<dd>5、实物礼品是{:C('ht_site_name')}与第三方网站合作完成的兑换。如因购买时价格变动，{:C('ht_site_name')}和会员双方均不需要作差价补偿。</dd>
					</dl>
				</div>
			</div>
		</div>
