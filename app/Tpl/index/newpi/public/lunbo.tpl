...
<div class="top_wrap">
    <div class="top_box">        
		...
		<dd>
        <a href="{:U('index/cate', array('cid'=>$bcate['id']))}"><i <gt name="bcate.cateimg|strlen" value="15">class="ct-icon" style="background: url({$bcate.cateimg}) no-repeat 0 0;" <else/> class="ct-icon ct-icon-{$bcate.cateimg}" </gt> ></i>{$bcate.name}<eq name="mod" value="0"><em class="ct-line"></em></eq></a>
        </dd>
		</if>
		</volist>                
        </dl>
