<div id="header">
  <div class="area">
    <h1>
      <a href="{:C('ht_site_url')}"><img src="{:C('ht_site_logo')}" height="45"></a>      
    </h1>
...
<div id="contentA">
  <div class="blockA area">
    ...
    <dl>
      <dt>多渠道展示</dt>
      <dd>
        {:C('ht_site_name')}主站首页推荐 <br>
       {:C('ht_site_name')}淘宝/QQ应用推荐 <br>
        {:C('ht_site_name')}官方微博推荐 覆盖60多万粉丝 <br>
       {:C('ht_site_name')}手机客户端及用户的传播和扩散
      </dd>
    </dl>
  </div>
  <div class="blockB area">
    ...
    <div class="scroll_div" id="scroll_div">
      <div id="scroll_begin"><b>最新通知：</b><a>{:C('ht_qq_code')}</a></div>
  ...
  <dl class="blockE area">
    <dt>规则协议</dt>
    <dd>
      <span><a href="#" target="_blank">·{:C('ht_site_name')}商家平台活动报名服务协议</a></span>
      <span><a href="#" target="_blank">·{:C('ht_site_name')}商家保证金协议</a></span>
      <span><a href="#" target="_blank">·{:C('ht_site_name')}商家违规处罚条例</a></span>
    </dd>
  </dl>
</div>