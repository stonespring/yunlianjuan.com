...
<meta name="generator" content="houtiantaoke">
<meta name="author" content="houtiantaoke Team  houtianbest.cn">
<meta name="copyright" content="2015-2017 houtianbest.cn Inc.">
...
<div class="seller-logo left">
	<a href="{:U('bao/index')}"><img src="{:C('ht_user_logo')}"  height="55px" alt="卖家中心" title="卖家中心"></a>
</div>
<ul class="nav_list right">
                <li class="frist"><a href="{:C('ht_site_url')}" target="_blank">首页</a></li>
...
<div class="seller-banner-left left">
		...
		<div class="notice-ul-out" id="demo">
			<ul>
			<li class="border-box" id="demo1">{:C('ht_qq_code')}</li>		
			<li class="border-box" id="demo2">{:C('ht_qq_code')}</li>	
			</ul>
		</div>
	</div>
