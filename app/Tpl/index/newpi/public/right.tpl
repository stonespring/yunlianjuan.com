<div class="side_right" style="display: one;">
		...
		<span class="wap">
            <a  class="trigger" href="{:C('ht_header_html')}">
                <p>浏览<br>手机版</p>
                <span><i class="icon icon-05"></i></span> </a>
            <div  class="normal-side-box app-side-box">
                <p class="app-show"><img src="{:C('ht_site_browser')}"></p>
			...
			<div class="normal-side-box">
                <div class="box-tips">
					...
					邀请访问<b>+{:C('ht_score_rule.union_visit')}</b>积分<br>
                    邀请注册<b>+{:C('ht_score_rule.union_reg')}</b>积分
                         </p>
                </div>
            <em class="cur-img"></em> 
			</div>
            ...
            <div class="normal-side-box">
                <div class="box-tips">
                    <p class="text">登录后 签到奖励<br>
                        <a target="_blank" href="{:U('gift/index')}">积分商城</a></p>
                    <p class="other"> 首次签到可得：<span> <b>{:C('ht_score_rule.sign')}</b> 积分</span><br>
					连续签到 <span>{:C('ht_score_rule.sign_day')}</span> 天<br>
                    每日递增 <span>{:C('ht_score_rule.sign_add')}</span> 积分
                         </p>
                </div>
            <em class="cur-img"></em> 
			</div>
