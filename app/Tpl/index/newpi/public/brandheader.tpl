...
<div class="header">
    <div class="area">
		...
		<form name="search" action="{:C('ht_site_url')}" method="get" id="search">
		   ...
		   <input x-webkit-speech name="k" id="k" autocomplete="off" onblur="this.value==''?this.value=this.title:null" onfocus="this.value==this.title?this.value='':null" title="请输入想找的宝贝" value="请输入想找的宝贝" class="txt" />
		   </span>
