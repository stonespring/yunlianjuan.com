...
<div class="dsearchtag w1200 _info">
  <div class="dsearchtag1 w1200">
    ...
    <div class="dsearchtag2 w1200">
      <p>{$item.name}优惠专场，实时更新高性价比{$item.name}单品、淘宝网{$item.name}打折特卖信息，全场低至1折起包邮，敬请关注！这些{$item.name}都是由专业编辑为您精挑细选的，时下最好、最流行的，欢迎进入页面了解{$item.name}价格、{$item.name}图片等相关信息！{:C('ht_site_name')}致力于帮您节省浏览海量商品信息时间，让您以更优惠的折扣价格购买到自己喜欢的{$item.name}！</p>
    </div>
</div>
...
<div class="intBrand w1200">
    ...
    <ul>
<ht:tag type="lists" num="200" keys="$tagid">
