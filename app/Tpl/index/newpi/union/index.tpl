...
<load href="__STATIC__/htian/new/css/md-pagination.css" />
<load href="__STATIC__/htian/new/css/md-goodslist.css" />
<load href="__STATIC__/htian/new/css/pg-zone.css" />
</head>
<body>
                    ...
                    <div class="jiu_visited">
						...
						<ul>
							...
							<div class="share_to">
								<dl>
								<dd>
								<textarea rows="2">我爱上了{:C('ht_site_name')}每天9块9的小幸福，包邮哦亲~注册还能免费得{:L('exchange')}，换礼品，更有超值商品专享！快来看看吧！</textarea>
								</dd>
							...
							<input class="links_in" type="text" value="[url={$union_url}]{:C('ht_site_name')}{$union_url}[/url]">
							<a class="links_btn" href="javascript:;">复制</a></dd>
							<dd><span class="links_txt">html代码：</span>
							<input class="links_in" type="text" value="&lt;a href = &quot;{$union_url}&quot;&gt;{:C('ht_site_name')}&lt;/a&gt;">
							<a class="links_btn" href="javascript:;">复制</a></dd>
							</dl>
							</li>
						</ul>
