...
<script src="/static/red/js/jquery1.7.2.min.js" type="text/javascript"></script>
<script src="/static/red/js/jquery.lazyload.min.js" type="text/javascript"></script>   
<script src="/static/red/js/pp18610_v2.1.min.js" type="text/javascript"></script>
<script src="/static/red/js/tuanpub3.0.min.js" type="text/javascript"></script>
<script src="/static/red/js/jucore.js" type="text/javascript"></script>
<script src="/static/red/js/zdm.js" type="text/javascript"></script>
<script type="text/javascript" src="/static/red/js/index.js"></script>
<script type="text/javascript" src="/static/red/js/funs.js"></script>
<link href="/static/red/css/articlezdm.css" media="screen" rel="stylesheet" type="text/css"/>
</head>
<body>
...
<div class="right"> 
  ...
  <h2>热门品牌</h2>
  <ul class="clear">
<ht:item type="hotbrand" num="30" order="id desc">
<volist name="data" id="item">
<li>
<div class="sjimg">
<a target="_blank" href="{:U('brand/view',array('id'=>$item['id']))}"><img src="{$item.logo}" width="70" height="35" alt="{$item.title}" title="{$item.title}"></a>
</div>  
</li>
</volist>
</ht:item>
...
<div class="re-top10">
<ul class="top-list">
<ht:article type="articlelists" num="10" cateid="$cid">
