...
<include file='public:top'/>  
        <div class="app">
            <div id="head">
                ...
                <div class="fixtop">
                    <span id="t-find"><a href="{:U('user/index')}" class="btn btn-left btn-back02" title="返回"></a></span>
                    <span id="t-index">新用户注册</span>
                    <span id="t-user"><a href="{:U('user/login')}" class="free-reg" rel="nofollow">登录</a></span>
                </div>
            </div>
