...
<body>
    <div class="main">
        ...
        <div class="app">
            ...
            <div class="about_us">
                <h1 class="logo"><img width="29%" src="{:C('ht_wap_logo')}"></h1>
                <ul class="about-box_v04">
                    <li>
                        <span class="juan04_title">上{:C('ht_site_name')}·购便宜</span>
                        <div class="mid-logo" style="width:100%"><img width="100%" src="/static/jwap/images/about/juan04_md.png"></div>
                        <p class="con">&nbsp;&nbsp;&nbsp;&nbsp;{:C('ht_site_name')}(<em>{:C('ht_site_url')}</em>)是一家专注网购省钱的折扣精选特卖平台。每日通过汇聚各大电商平台的独家折扣精品，以更低的价格优惠，严格的样品质检和服务监督，为广大的用户提供最实惠的商品和完整的网购服务,是目前中国成长最快的电子商务企业之一。<br>&nbsp;&nbsp;&nbsp;&nbsp;{:C('ht_site_name')}（九块邮）旗下的一款9.9元包邮移动购物应用。<br>&nbsp;&nbsp;</p>
                    </li>
