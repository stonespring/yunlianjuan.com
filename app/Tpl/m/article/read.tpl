...
<div class="item-good">                  
                    ...
                    <h1>{$article.title}</h1>
					<div class="list-price buy" style="font-size:13px"><span class="price-new fl" style="font-size:13px"><i style="font-size:13px">来源：</i><a href="{:C('ht_site_url')}" title="点击访问 {:C('ht_site_name')}" target='_self'>{:C('ht_site_name')}</a></span><i class="fr" style="font-size:13px">阅读：<em style="font-size:13px;padding:0;vertical-align:0;">(<code class="hits">{$tron.hits}</code>)</em></i>
					</div>
