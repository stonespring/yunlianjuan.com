        ...
        <tr>
            ...
            <td>
               ...
               <label><input type="radio" name="type" class="radio_style" value="wap">&nbsp;手机左侧导航</label>
                ...
                <label><input type="radio" name="type" class="radio_style" value="other">&nbsp;手机首页图标&nbsp;&nbsp;&nbsp;</label><br/>
								<label><input type="radio" name="type" class="radio_style" value="botmenu">&nbsp;手机底部导航&nbsp;&nbsp;&nbsp;</label>
