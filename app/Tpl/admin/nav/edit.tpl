...
<div class="dialog_content">
    ...
    <table width="100%" class="table_form">
        ...
        <if condition="($info['type'] eq 'other')or($info['type'] eq 'botmenu')">
...
<br/>
				<label><input type="radio" name="type" class="radio_style" value="botmenu" <if condition="$info['type'] eq 'botmenu'"> checked="checked"</if>>&nbsp;手机底部导航&nbsp;&nbsp;&nbsp;</label>
