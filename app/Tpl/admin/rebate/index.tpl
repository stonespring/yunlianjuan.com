...
<div class="pad_10" >
    ...
    <div class="J_tablelist table_list" data-acturi="{:U('rebate/ajax_edit')}">
    <table width="100%" cellspacing="0">
		...
		<td align="center">{$val.estimate_income}</td>         <td align="center">{$val.commission}</td> 
                ...
                <td align="center">
				<a href="javascript:void(0);" class="J_confirmurl" data-uri="{:u('rebate/delete', array('id'=>$val['id']))}" data-acttype="ajax" data-msg="{:sprintf(L('confirm_delete_one'),$val['title'])}">{:L('delete')}</a></td>
            </tr>
            </volist>
        </tbody>
    </table>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="{:U('rebate/delete')}" data-name="id" data-msg="{:L('confirm_delete')}" value="{:L('delete')}" />
