...
<div class="subnav">
<h1 class="title_2 line_x">批量申请定向计划(申请理由必填，申请之前需先在采集设置中设置阿里妈妈cookies和网站ID、推广位ID)<a href="http://houtianbest.cn/thread-7590-1-1.html" target="_blank">查看教程。</a></h1>
</div>
<div class="pad_lr_10">
...
$(function(){
    var collect_url = "{:U('jctata/jchoutian')}";
    ...
    function complete(result){
        if(result.status == 1){
            ...
            $.houtian.tip({content:result.msg, icon:'alert'});
        }
    }
