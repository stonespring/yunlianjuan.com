...
<div class="pad_lr_10">
	...
	<tr>
            ...
            <td>
                <label><input type="radio" <if condition="C('ht_tag_auto') eq '1'">checked="checked"</if> value="1" name="setting[tag_auto]"> 是</label> &nbsp;&nbsp;
                <label><input type="radio" <if condition="C('ht_tag_auto') eq '0'">checked="checked"</if> value="0" name="setting[tag_auto]"> 否</label>
	...
	<tr>
            ...
            <td><input type="text" name="setting[item_add_time]" size="10" class="input-text" value="{:C('ht_item_add_time')}" />&nbsp;&nbsp;小时&nbsp;&nbsp;<span class="gray">一般72小时，三天过期</span></td>
        </tr>


	<tr>
            <th width="150">新浪微博地址 :</th>
            <td><input type="text" name="setting[sina_url]" size="50" class="input-text" value="{:C('ht_sina_url')}" />&nbsp;&nbsp;<span class="gray">新浪微博地址</span></td>
        </tr>
	<tr>
            <th width="150">QQ空间地址 :</th>
            <td><input type="text" name="setting[qzone_url]" size="50" class="input-text" value="{:C('ht_qzone_url')}" />&nbsp;&nbsp;<span class="gray">QQ空间地址</span></td>
        </tr>
	<tr>
            <th width="150">腾讯微博地址 :</th>
            <td><input type="text" name="setting[tenxun_url]" size="50" class="input-text" value="{:C('ht_tenxun_url')}" />&nbsp;&nbsp;<span class="gray">腾讯微博地址</span></td>
        </tr>
	...
	<tr>
		<th>网站主Logo :</th>
        	<td>
            		<input type="text" name="setting[site_logo]" id="J_logo_img" class="input-text fl mr10" size="50" value="{:C('ht_site_logo')}">
            		<div id="J_logo_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
			<img src="{:C('ht_site_logo')}" id="show_logo_J_img" style="height:45px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	<tr>
		<th>顶部搜索框左则长图 :</th>
        	<td>
            		<input type="text" name="setting[site_navlogo]" id="J_navlogo_img" class="input-text fl mr10" size="50" value="{:C('ht_site_navlogo')}">
            		<div id="J_navlogo_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
			<img src="{:C('ht_site_navlogo')}" id="show_navlogo_J_img" style="width:335px;height:25px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	<tr>
		<th>商品背景图片 :</th>
        	...
        	<td>
            		<input type="text" name="setting[site_flogo]" id="J_flogo_img" class="input-text fl mr10" size="50" value="{:C('ht_site_flogo')}">
            		<div id="J_flogo_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
			<img src="{:C('ht_site_flogo')}" id="show_flogo_J_img" style="width:100px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
<tr>
		<th>右侧浮动导航手机二维码:</th>
        	<td>
            		<input type="text" name="setting[site_browser]" id="J_browser_img" class="input-text fl mr10" size="50" value="{:C('ht_site_browser')}">
            		<div id="J_browser_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
			<img src="{:C('ht_site_browser')}" id="show_browser_J_img" style="width:128px;height:128px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
               <tr>
        <th>报名中心LOGO :</th>
        <td>
          <input type="text" name="setting[user_logo]" id="J_user_img" class="input-text fl mr10" size="50" value="{:C('ht_user_logo')}">
          <div id="J_user_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
          <img src="{:C('ht_user_logo')}" id="show_user_J_img" style="width:260px;height:50px;"/>
	...
	<tr>
		<th>网站底部二维码 :</th>
        	<td>
            		<input type="text" name="setting[site_weixin]" id="J_weixin_img" class="input-text fl mr10" size="50" value="{:C('ht_site_weixin')}">
            		<div id="J_weixin_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
			<img src="{:C('ht_site_weixin')}" id="show_weixin_J_img" style="width:90px;height:90px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	<tr>
        	<th></th>
