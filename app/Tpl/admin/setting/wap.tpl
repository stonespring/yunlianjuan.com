...
<div class="pad_lr_10">
	...
	<table width="100%" class="table_form">
        ...
        <td>
            <input type="text" name="setting[wap_logo]" id="J_waplogo_img" class="input-text fl mr10" size="50" value="{:C('ht_wap_logo')}">
            <div id="J_waplogo_upload_img" class="upload_btn"><span>{:L('upload')}</span></div>
			<img src="{:C('ht_wap_logo')}" id="show_waplogo_J_img" style="height:45px;"/>
			<span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
		<tr>
            <th width="150">手机版SEO标题 :</th>
            <td><input type="text" name="setting[wap_title]" class="input-text" size="80" value="{:C('ht_wap_title')}">			
			</td>
        </tr>
		<tr>
            <th width="150">手机版SEO关键词 :</th>
            <td><input type="text" name="setting[wap_keywords]" class="input-text" size="80" value="{:C('ht_wap_keywords')}"></td>
        </tr>
		<tr>
            <th width="150">手机版SEO描述 :</th>
            <td>
			<textarea rows="4" cols="80" name="setting[wap_description]">{:C('ht_wap_description')}</textarea>			
			</td>
        </tr> 
