...
<body scroll="no">
<div id="header">
	<div class="logo"><a href="{:C('ht_site_url')}" title="{:L('website_manage')}" target="_blank"></a></div>
	...
	<div class="t_right">
	            <a href="javascript:;" title="{:L('flush_cache')}" id="J_flush_cache" class="t_cache" data-uri="{:U('cache/qclear')}" hidefocus="true">{:L('flush_cache')}</a>
            	<a href="javascript:;" title="{:L('background_map')}" id="J_admin_map" class="t_map" data-uri="{:U('index/map')}" hidefocus="true">{:L('background_map')}</a>
				<a href="javascript:;" title="{:L('refresh_page')}" id="J_refresh" class="t_refresh" hidefocus="true">{:L('refresh_page')}</a>
				<a href="{:C('ht_site_url')}" title="网站首页" id="J_home" class="t_home" hidefocus="true" target="_blank">网站首页</a>
	</div>
</div>
<div id="content">
