...
<div class="subnav">
    <h1 class="title_2 line_x">获取阿里妈妈后台选品库 <a href="http://houtianbest.cn/thread-19-1-1.html" target="_blank">查看教程</a></h1>
</div>
...
.add:hover{background-position: 0 -34px;text-decoration: none;}
    ...
    <table width="100%" cellspacing="0" class="table_form">
        <tbody>
		  ...
		  <input type="submit" value="获取列表" class="btn fb" style="margin: 0 0 0 200px;">	
          </div>				 
          </td>		  
          </tr>	
