...
.add:hover{background-position: 0 -34px;text-decoration: none;}
    ...
    <table width="100%" cellspacing="0" class="table_form">
        <tbody>
		  ...
		  <input type="hidden" name="m" value="houtianso" />
...
<div class="pad_lr_10" >
        ...
        <tbody>
         <volist name="list" id="val" key="i" mod="4"> 
            <tr>
                ...
                <td align="center"><a class="showdialog" href="javascript:getck({$val.num_iid});" data-uri="{:U('houtianso/caiji',array('id'=>$val['num_iid']))}" data-title="采集" data-id="caiji" data-width="500" data-height="180">采集</a></td>
    ...
    <div class="btn_wrap_fixed">
		...
		<input type="button" class="btn btn_submit" data-tdtype="batch_action" data-acttype="ajax_form" data-id="allcaiji" data-uri="{:U('houtianso/allcaiji',array('menuid'=>$menuid,'p'=>$p))}" data-name="num_iid" data-title="批量采集入库" value="批量采集入库" />
