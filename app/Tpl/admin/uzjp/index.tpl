...
<div class="pad_lr_10">
	...
	<br><br>
	<h2>友情提示：本插件是直接采集卷皮尺官方U站的商品，同步获取卖家旺旺和卖家数字ID。采集过程中会自动过虑已存在的商品和信息不完整的商品，所以运行过程时间会长一点，视个人网站服务器配置情况而定，如果响应时间过长，请刷新后重新采集，或重启服务器重新采集，建议选择网络不繁忙的时段进行采集。后天网络提供技术支持、</h2>
</div>
