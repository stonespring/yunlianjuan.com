	...
	<form id="info_form" action="{:u('cache/clear')}" method="post">
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				...
				<td><img src="/static/images/admin/folde.gif" width="16" height="14"> data/runtime/HtianAPI</td>
				<td>后天API缓存</td>
				<td><span class="gray mr10">清空后天网络开放平台API缓存文件</span><span id="api_ifm"></span></td>
			</tr>
