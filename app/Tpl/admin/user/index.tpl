    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="120"><span data-tdtype="order_by" data-field="money">可用余额</span></th>
				<th width="120"><span data-tdtype="order_by" data-field="available_money">账户余额</span></th>
				<th width="120"><span data-tdtype="order_by" data-field="invite_friend_count">邀请好友</span></th>
				<th width="120"><span data-tdtype="order_by" data-field="agent_id">代理级别</span></th>
    	...
    	<tbody>
            ...
            <tr>
				...
				<td align="center">{$val.available_money}</td>
				<td align="center">{$val.invite_friend_count}</td>
				<td align="center"><volist name="agent_list" id="agent_info"><if condition="$val['agent_id'] eq $agent_info['id']">{$agent_info.name}</if></volist></td>
